...
![Dygraph using my custom macro.](./_assets/graphs/xo_2024.csv){#fig:custom1}
...
1. Short-form : input labeled data only w/ a link to a `data.csv` this shape:
    ...
    ```markdown
    ![Graph caption](_assets/graphs/data1.csv){#fig:graph1 x="Data1 (unit)" y="Data2, Data3"}
    ```
    ...
    **TEST:**
    ...
    ![Graph caption](_assets/graphs/data1.csv){#fig:graph1 x="Data1 (unit)" y="Data2, Data3" xlabel="Légende X" ylabel="Légende Y"}
...
![Importation test of an SVG image.](_assets/pics/sic_on_glass_iso.svg){#fig:test_svg width="80%"}

## Margin figures

![Margin figure](_assets/pics/usa-census.png){#fig:figmargin .margin}

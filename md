...
![Caption](pic/usa-census.png){#fig:label1}

![This is a second image](pic/usa-census.png){#fig:label2 .wide}

![This is a reduced image](pic/usa-census.png){#fig:label3 width="50%"}

![This is (meant to be) a margin image](pic/usa-census.png){#fig:label
.margin}
...
::: wide
  -----------------------------------------------------------------------------------------------------------------------------------------------
  Mois                    jan.      fÃ©v.     mars      avril    mai      juin    jui.    aoÃ»t   sep.     oct.     nov.      dÃ©c.     annÃ©e
  ----------------------- --------- --------- --------- -------- -------- ------- ------- ------- -------- -------- --------- --------- ---------
  Temp. minimale moyenne  âˆ'0.8    âˆ'0.6    2.5       5.2      9.8      12.8    14.5    14.1    10.6     7.1      2.8       0.3       6.6
  (Â°C)                                                                                                                                 

  Temp. moyenne (Â°C)     1.9       2.9       7         10.5     15       18.1    20.1    19.8    15.8     11.2     5.8       2.8       10.9

  Temp. maximale moyenne  4.5       6.4       11.1      15.7     20.2     23.4    25.7    25.4    21       15.3     8.8       5.2       15.3
  (Â°C)                                                                                                                                 

  Record de froid (Â°C)   âˆ'23.6   âˆ'22.3   âˆ'16.7   âˆ'5.6   âˆ'2.4   1.1     4.9     4.8     âˆ'1.3   âˆ'7.6   âˆ'10.8   âˆ'23.4   âˆ'23.6

  Record de chaleur (Â°C) 17.5      21.1      25.7      30       33.8     38.8    38.9    38.7    33.4     29.1     22.1      18.3      38.9
  ...
  PrÃ©cipitations (mm)    32.2      34.5      42.8      45.9     81.9     71.6    72.7    61.4    63.5     61.5     47        50        664.6

  Nb. de jours avec       8.4       8.1       9.1       9.2      11.5     10.8    9.9     10.2    8.6      9.5      9.3       9.8       114.9
  prÃ©cipitations                                                                                                                       

  HumiditÃ© relative (%)  86        82        76        72       73       74      72      76      80       85       86        86        79
...
Unicode is supported. â˜º
  ...
  : table in just a chapter section {#tbl:chaptab}
...
Tables can look like this:
  ...
  : Shoes sizes, materials, and colors. {#tbl:table2}
...
![example
image](example-image.jpg "An exemplary image"){#fig:example-image}
...
[^1]: This is the text in the side note. It is smaller and only supports
    inline elements, like **bold** or [links](#), but not lists or code
    blocks.
...
[^15]: This is the text in the side note. It is smaller and only
    supports inline elements, like **bold** or [links](#), or math:
    $e^{i\pi} +1 = 0$ !
